...
let isOpen = function (drawer) {
        return (
            drawer.attr("data-open-drawer") == "1" || drawer.hasClass("open")
        );
    },
    ...
    getLeftDrawer = function () {
        ...
        d.each(function () {
            if (
                typeof d.attr("data-right-drawer") === "undefined" ||
                d.attr("data-right-drawer") == "0"
            ) {
                ld = d;
                return false;
            }
...
$(function () {
    ...
    if (window.innerWidth < 576 && window.location.pathname != "/chats") {
        closeDrawer();
    }
});
